    ...
    <ListContainer>
      <ul>
        <li>
          ...
          HTML : 프론트엔드와 퍼블리싱의 기본이 되는 언어로 가장 오랫동안 사용했습니다.
        </li>
        <li>
          <AiOutlineCheckCircle />
          CSS : 프론트엔드와 퍼블리싱의 기본이 되는 언어로 가장 오랫동안 사용했습니다.
        </li>
        <li>
          <AiOutlineCheckCircle />
          JavaScript : 프론트엔드를 목표로 삼으며 여러 프레임워크와 함께 2년정도 공부하였습니다.
        </li>
        <li>
          <AiOutlineCheckCircle />
          Java : 백엔드를 겸하고싶어 국비지원 수업을 들은 적이 있습니다.
        </li>
      </ul>
    </ListContainer>
  );
